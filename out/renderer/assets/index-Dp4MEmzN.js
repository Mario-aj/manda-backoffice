    ...
    if (opts.formEncType === "text/plain") {
      ...
      let text = typeof opts.body === "string" ? opts.body : opts.body instanceof FormData || opts.body instanceof URLSearchParams ? (
        ...
        Array.from(opts.body.entries()).reduce(
          (acc, [name, value2]) => `${acc}${name}=${value2}
`,
          ""
        )
      ) : String(opts.body);
...
var loadLazyRouteProperty = ({
  ...
  let propertyPromise = (async () => {
    ...
    if (isUnsupported) {
      ...
      if (value2 != null) {
        Object.assign(routeToUpdate, { [key]: value2 });
...
async function callRouteMiddleware(args, middlewares, handler, processResult, isResult, errorHandler, idx = 0) {
  ...
  try {
    let value2 = await middleware(args, next);
    let result = value2 != null ? processResult(value2) : void 0;
    if (isResult(result)) {
      return result;
    } else if (nextResult) {
...
function createDataFunctionUrl(request, path) {
  ...
  if (parsed.search) {
    ...
    for (let value2 of indexValues.filter(Boolean)) {
      searchParams.append("index", value2);
    }
...
function isDataStrategyResults(result) {
  return result != null && typeof result === "object" && Object.entries(result).every(
    ([key, value2]) => typeof key === "string" && isDataStrategyResult(value2)
  );
}
...
function Router({
  ...
  }, [basename, pathname, search2, hash, state, key, navigationType, mask]);
  warning(
...
function PrefetchPageLinks({ page: page2, ...linkProps }) {
  ...
  let matches = reactExports.useMemo(
    () => matchRoutes(router2.routes, page2, router2.basename),
    [router2.routes, page2, router2.basename]
  );
  if (!matches) {
    return null;
  }
  ...
  if (rsc) {
    return /* @__PURE__ */ reactExports.createElement(RSCPrefetchPageLinksImpl, { page: page2, matches, ...linkProps });
  }
  return /* @__PURE__ */ reactExports.createElement(PrefetchPageLinksImpl, { page: page2, matches, ...linkProps });
}
...
function normalizeApiMessage(body, fallback) {
    ...
    defaultOptions: {
      queries: {
        ...
        retry: (failureCount, error2) => {
          if (error2 instanceof ApiError && error2.status >= 400 && error2.status < 500) {
            return false;
          }
...
prototype.toString = function toString2(encoder) {
  const _encode = encoder ? (value2) => encoder.call(this, value2, encode$1) : encode$1;
...
let authLostListener = null;
function setAuthLostListener(cb) {
  authLostListener = cb;
}
function isStaffAuthEndpoint(url) {
  if (!url) return false;
  return url.endsWith("/staff/auth/login") || url.endsWith("/staff/auth/refresh");
}
...
api.interceptors.response.use(
  (r) => r,
  async (error2) => {
    const original = error2.config;
    const status = error2.response?.status;
    const body = error2.response?.data;
    if (status === 401 && original && !original._retry && !isStaffAuthEndpoint(original.url)) {
      ...
      if (refreshed) {
        const headers = AxiosHeaders2.from(original.headers);
    ...
    const message = normalizeApiMessage(
      body,
      error2.message || "Erro de rede. Tente novamente."
    );
    return Promise.reject(new ApiError(message, status ?? 0, body));
  }
);
async function login(input2) {
  const res = await api.post("/staff/auth/login", input2);
  const tokens = {
    accessToken: res.data.accessToken,
    refreshToken: res.data.refreshToken,
    expiresIn: res.data.expiresIn
...
const ME_KEY = ["staff", "me"];
function useLoginMutation(setHasTokens) {
...
function useLogoutMutation(setHasTokens) {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: logout,
    onSettled: () => {
...
function AuthProvider({ children }) {
  ...
  const [hasTokens, setHasTokens] = reactExports.useState(false);
  reactExports.useEffect(() => {
    let alive = true;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthContext.Provider, { value: value2, children });
}
function useAuth() {
...
const screen = "_screen_1b3km_1";
const styles$b = {
  screen
};
function LoadingScreen({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$b.screen, children });
}
function AuthGuard() {
  const { status } = useAuth();
  if (status === "loading") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingScreen, { children: "A verificar sessão…" });
  }
...
function GuestGuard() {
  const { status } = useAuth();
  if (status === "loading") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingScreen, { children: "A carregar…" });
  }
...
const glyph = "_glyph_1smkk_1";
const size36$1 = "_size36_1smkk_17";
const icon = "_icon_1smkk_21";
const iconFill = "_iconFill_1smkk_26";
const iconStroke = "_iconStroke_1smkk_31";
const styles$a = {
  glyph,
  size36: size36$1,
  icon,
...
function MandaGlyph({ size = 32 }) {
  const className = [styles$a.glyph, size === 36 ? styles$a.size36 : ""].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: styles$a.icon, viewBox: "0 0 24 24", fill: "none", "aria-hidden": true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "path",
      {
        className: styles$a.iconFill,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { className: styles$a.iconStroke, d: "M7 10.5L11 13.5L17 7.5" })
  ] }) });
}
const wordmark = "_wordmark_133dv_1";
const size24 = "_size24_133dv_11";
const light = "_light_133dv_15";
const dot = "_dot_133dv_19";
const styles$9 = {
  wordmark,
  size24,
  light,
...
function MandaWordmark({ size = 28, variant = "default" }) {
  const className = [
    styles$9.wordmark,
    size === 24 ? styles$9.size24 : "",
    variant === "light" ? styles$9.light : ""
  ].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className, children: [
    "manda",
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$9.dot, children: "." })
  ] });
}
const label = "_label_ishv0_1";
const labelText = "_labelText_ishv0_5";
const input = "_input_ishv0_14";
const styles$8 = {
  label,
  labelText,
  input
...
function TextField({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: styles$8.label, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$8.labelText, children: label2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
...
const button = "_button_1p8ce_1";
const buttonFull = "_buttonFull_1p8ce_19";
const styles$7 = {
  button,
  buttonFull
};
function PrimaryButton({
  ...
  const className = [styles$7.button, full ? styles$7.buttonFull : ""].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type, onClick, disabled: isDisabled, className, children: loading ? "A entrar…" : children });
}
const fields = "_fields_10ulc_1";
const error = "_error_10ulc_7";
const errorIcon = "_errorIcon_10ulc_20";
const errorIconCircle = "_errorIconCircle_10ulc_24";
const errorIconLine = "_errorIconLine_10ulc_30";
const actions = "_actions_10ulc_37";
const styles$6 = {
  fields,
  error,
  errorIcon,
...
function LoginForm() {
  ...
  const errorMessage = loginMutation.error instanceof ApiError ? loginMutation.error.message : loginMutation.error ? "Erro de rede. Tente novamente." : null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.fields, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextField,
        {
          label: "Email",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        errorMessage && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.error, role: "alert", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              className: styles$6.errorIcon,
              width: "15",
              height: "15",
              viewBox: "0 0 24 24",
              fill: "none",
              "aria-hidden": true,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { className: styles$6.errorIconCircle, cx: "12", cy: "12", r: "9" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("path", { className: styles$6.errorIconLine, d: "M12 7.5v5.5M12 16h.01" })
              ]
            }
          ),
          errorMessage
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.actions, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      PrimaryButton,
      {
        type: "submit",
        full: true,
...
const page = "_page_50q4f_1";
const decoration = "_decoration_50q4f_10";
const card$1 = "_card_50q4f_20";
const brandRow = "_brandRow_50q4f_30";
const title$2 = "_title_50q4f_36";
const subtitle = "_subtitle_50q4f_44";
const formWrap = "_formWrap_50q4f_50";
const footer$1 = "_footer_50q4f_54";
const styles$5 = {
  page,
  decoration,
  card: card$1,
...
function LoginPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.page, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5.decoration, "aria-hidden": true }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.card, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.brandRow, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MandaGlyph, { size: 36 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(MandaWordmark, { size: 24 })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: styles$5.title, children: "Entrar no backoffice" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$5.subtitle, children: "Acesso restrito à equipa de operações." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5.formWrap, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoginForm, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$5.footer, children: "Acesso restrito à equipa Manda · sessões auditadas" })
    ] })
  ] });
}
const avatar = "_avatar_ufo10_1";
const size36 = "_size36_ufo10_17";
const size38 = "_size38_ufo10_21";
const styles$4 = {
  avatar,
  size36,
  size38
...
function Avatar({ name = "?", size = 44 }) {
  ...
  const sizeClass = size === 36 ? styles$4.size36 : size === 38 ? styles$4.size38 : void 0;
  const avatarStyle = {
    "--avatar-bg": bg,
    "--avatar-ink": ink
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: [styles$4.avatar, sizeClass].filter(Boolean).join(" "), style: avatarStyle, children: initials });
}
const sidebar = "_sidebar_12o79_1";
const brand = "_brand_12o79_11";
const brandLabel = "_brandLabel_12o79_18";
const nav = "_nav_12o79_26";
const navItem = "_navItem_12o79_33";
const navItemDisabled = "_navItemDisabled_12o79_45";
const navItemLabel = "_navItemLabel_12o79_50";
const navItemBadge = "_navItemBadge_12o79_54";
const navIcon = "_navIcon_12o79_62";
const spacer = "_spacer_12o79_66";
const footer = "_footer_12o79_70";
const footerMeta = "_footerMeta_12o79_78";
const footerName = "_footerName_12o79_83";
const logoutButton = "_logoutButton_12o79_92";
const styles$3 = {
  sidebar,
  brand,
  brandLabel,
...
function ShieldIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: styles$3.navIcon, width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", "aria-hidden": true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "path",
    {
...
function Sidebar() {
  ...
  const roleLabel = staff ? ROLE_LABELS$1[staff.role] : "";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: styles$3.sidebar, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.brand, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MandaWordmark, { size: 24, variant: "light" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.brandLabel, children: "Backoffice" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: styles$3.nav, "aria-label": "Navegação principal", children: NAV_ITEMS.map((item) => {
      const Icon = item.icon;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: [styles$3.navItem, item.disabled ? styles$3.navItemDisabled : ""].filter(Boolean).join(" "),
          title: item.disabled ? "Em breve" : void 0,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.navItemLabel, children: item.label }),
            item.disabled && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.navItemBadge, children: "Em breve" })
          ]
        },
        item.key
      );
    }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.spacer }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.footer, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { name: displayName, size: 36 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.footerMeta, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.footerName, children: displayName }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            className: styles$3.logoutButton,
...
const topbar = "_topbar_1j1ms_1";
const title$1 = "_title_1j1ms_12";
const search = "_search_1j1ms_20";
const searchIcon = "_searchIcon_1j1ms_35";
const searchIconCircle = "_searchIconCircle_1j1ms_40";
const searchIconLine = "_searchIconLine_1j1ms_46";
const styles$2 = {
  topbar,
  title: title$1,
  search,
...
function Topbar({ title: title2 }) {
  const { staff } = useAuth();
  const displayName = staff?.fullName ?? "Staff";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: styles$2.topbar, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: styles$2.title, children: title2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.search, title: "Em breve", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: styles$2.searchIcon, width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", "aria-hidden": true, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { className: styles$2.searchIconCircle, cx: "11", cy: "11", r: "7" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { className: styles$2.searchIconLine, d: "M20 20l-4-4" })
      ] }),
      "Procurar utilizador, ref MND…"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { name: displayName, size: 38 })
  ] });
}
const shell = "_shell_f3l9f_1";
const mainColumn = "_mainColumn_f3l9f_7";
const content = "_content_f3l9f_14";
const styles$1 = {
  shell,
  mainColumn,
  content
};
function AppShell({ title: title2 = "Início" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.shell, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.mainColumn, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Topbar, { title: title2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: styles$1.content, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
    ] })
  ] });
}
const card = "_card_181vi_1";
const title = "_title_181vi_9";
const lead = "_lead_181vi_16";
const details = "_details_181vi_23";
const term = "_term_181vi_31";
const value = "_value_181vi_36";
const valueStrong = "_valueStrong_181vi_42";
const styles = {
  card,
  title,
  lead,
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.card, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: styles.title, children: "Sessão iniciada" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles.lead, children: "Bem-vindo ao backoffice Manda. As funcionalidades de KYC e transações estarão disponíveis em breve." }),
    staff && /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { className: styles.details, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: styles.term, children: "Nome" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: styles.valueStrong, children: staff.fullName }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: styles.term, children: "Email" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: styles.value, children: staff.email }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: styles.term, children: "Função" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: styles.value, children: ROLE_LABELS[staff.role] })
    ] })
  ] });
}
const router = createBrowserRouter([
  {
    element: /* @__PURE__ */ jsxRuntimeExports.jsx(GuestGuard, {}),
    children: [{ path: "/login", element: /* @__PURE__ */ jsxRuntimeExports.jsx(LoginPage, {}) }]
  },
  {
    element: /* @__PURE__ */ jsxRuntimeExports.jsx(AuthGuard, {}),
    children: [
      {
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, { title: "Início" }),
        children: [{ index: true, element: /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, {}) }]
      }
    ]
  },
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SplashGate, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider2, { router }) }) }) });
}
