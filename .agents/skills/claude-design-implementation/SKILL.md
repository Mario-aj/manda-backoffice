...
**Read first (auto-loaded via `.agents/rules/`):**

- `.agents/rules/architecture.md` — feature layout, staff auth, API, styling
- `.agents/rules/behavioral-guidelines.md` — staff security posture
...
| Mobile app (`manda-app/`, Expo, expo-router)    | No             | `manda-app/.agents/skills/claude-design-implementation/` |
