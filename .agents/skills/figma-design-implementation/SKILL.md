...
**Read:** `.agents/rules/architecture.md`, `.agents/rules/behavioral-guidelines.md`.
...
Reuse existing components before creating new ones — see `.agents/rules/reuse-before-create.md`.
